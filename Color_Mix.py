def colors(N):
	C = ["#7F7F7F", "#1F77B4", "#FF7F0E", "#2CA02C", "#D62728", "#9467BD",
      "#8C564B", "#E377C2", "#BCBD22", "#17BECF", "#3339FF", "#FFE333",
      "#FF4A46", "#7B7BC2", "#008941", "#CCAA35", "#1CE6FF", 
      "#FF34FF", "#FD9FA6", "#006FA6", "#A30059", "#7A4900", 
      "#63FFAC", "#B79762", "#004D43", "#8FB0FF", "#997D87", "#809693", 
      "#688A08", "#1B4400", "#4FC601", "#3B5DFF", "#4A3B53", "#FF2F80", 
      "#61615A", "#BA0900", "#6B7900", "#00C2A0", "#FFAA92", "#FF90C9", 
      "#B903AA", "#D16100", "#5293CC", "#000035", "#7B4F4B", "#A1C299", 
      "#300018", "#0AA6D8", "#013349", "#00846F", "#372101", "#FFB500", 
      "#68FFD2", "#A079BF", "#CC0744", "#C0B9B2", "#C2FF99", "#001E09", 
      ...
      "#5B4534", "#FFA571", "#404E55", "#0089A3", "#CB7E98", "#A4E804", 
      ...
      "#671190", "#6B3A64", "#F5E1FF", "#FFA0F2", "#FFFF00", "#374527", 
...
def colors_noNoise(N):
	C = ["#7F7F7F", "#1F77B4", "#FF7F0E", "#2CA02C", "#D62728", "#9467BD",
      "#8C564B", "#E377C2", "#BCBD22", "#17BECF", "#3339FF", "#FFE333",
      "#FF4A46", "#0000A6", "#008941", "#000000", "#CCAA35", "#1CE6FF", 
      "#FF34FF", "#5A0007", "#006FA6", "#A30059", "#FF8000", "#7A4900", 
      "#63FFAC", "#B79762", "#004D43", "#8FB0FF", "#997D87", "#809693", 
      "#688A08", "#1B4400", "#4FC601", "#3B5DFF", "#4A3B53", "#FF2F80", 
      "#61615A", "#BA0900", "#6B7900", "#00C2A0", "#FFAA92", "#FF90C9", 
      "#B903AA", "#D16100", "#5293CC", "#000035", "#7B4F4B", "#A1C299", 
